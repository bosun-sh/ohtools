...
- `spec/06-schema-and-validation/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Validate run input before handlers and output after handlers when schemas exist.

## Scope

- Runtime validation pipeline and validation errors.
...
- Include all edge cases from `spec/06-schema-and-validation/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/06-schema-and-validation/SPEC.md` that apply to this task.
