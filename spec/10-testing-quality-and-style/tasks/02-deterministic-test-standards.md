...
- `spec/10-testing-quality-and-style/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Define and enforce deterministic test practices with no network dependency.

## Scope

- Test helpers, fixtures, snapshots, and path-stability rules.
...
- Include all edge cases from `spec/10-testing-quality-and-style/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/10-testing-quality-and-style/SPEC.md` that apply to this task.
