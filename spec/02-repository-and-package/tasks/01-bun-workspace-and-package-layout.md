# Bun Workspace and Package Layout
...
Create the Bun workspace and package/app/example directory contracts.

## Scope

- Root workspace, packages/ohtools, apps/docs, examples/*, and TypeScript layout.
