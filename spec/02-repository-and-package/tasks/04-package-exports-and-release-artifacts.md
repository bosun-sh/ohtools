# Package Exports and Release Artifacts
...
- `spec/02-repository-and-package/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Define public exports, build outputs, CLI binary path, and npm package contents.

## Scope

- packages/ohtools package metadata, exports, dist output, files, and bin.
...
- Include all edge cases from `spec/02-repository-and-package/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/02-repository-and-package/SPEC.md` that apply to this task.
