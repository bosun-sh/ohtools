...
- `spec/12-public-launch/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Run smoke paths against the packed tarball before publish and npm package after publish.

## Scope

- Temporary Bun smoke projects and smoke scripts.
...
| Develop | gpt-5.3-codex | Scoped implementation that satisfies the task requirements. |
| Validate | gpt-5.4 | Commands run, results recorded, and done criteria checked. |
...
- Include all edge cases from `spec/12-public-launch/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/12-public-launch/SPEC.md` that apply to this task.
