...
- `spec/00-ai-development-contract/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Define how stage requirements become implementation-ready task files before coding begins.

## Scope

- Stage task lists, readiness criteria, and task dependencies.
...
- Include all edge cases from `spec/00-ai-development-contract/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/00-ai-development-contract/SPEC.md` that apply to this task.
