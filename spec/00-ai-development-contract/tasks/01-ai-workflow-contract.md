...
Define the agent workflow rules that keep implementation aligned with the numbered specs and product vision.

## Scope

- Spec process docs and future validation checks.
