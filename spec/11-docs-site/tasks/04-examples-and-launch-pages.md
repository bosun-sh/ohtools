...
- `spec/11-docs-site/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Link runnable examples and publish launch/install/version compatibility pages.

## Scope

- Examples pages, launch docs, and version notes.
...
- Include all edge cases from `spec/11-docs-site/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/11-docs-site/SPEC.md` that apply to this task.
