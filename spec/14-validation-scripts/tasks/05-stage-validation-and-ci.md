...
- `spec/14-validation-scripts/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Make stage validation cumulative and wire CI/release workflows to the required scripts.

## Scope

- validate:* scripts, CI workflow, and release workflow.
...
- Include all edge cases from `spec/14-validation-scripts/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/14-validation-scripts/SPEC.md` that apply to this task.
