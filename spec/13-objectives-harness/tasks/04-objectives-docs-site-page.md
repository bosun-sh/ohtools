...
- `spec/13-objectives-harness/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Publish the objectives harness in the Astro docs site and link it from required docs.

## Scope

- Docs /objectives page and links.
...
- Include all edge cases from `spec/13-objectives-harness/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/13-objectives-harness/SPEC.md` that apply to this task.
