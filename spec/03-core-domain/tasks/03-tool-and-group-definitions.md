...
- `spec/03-core-domain/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Represent tools and groups as core definitions with descriptions, handlers, metadata, and hierarchy fields.

## Scope

- Tool/group definition model and resolution contracts.
...
- Include all edge cases from `spec/03-core-domain/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/03-core-domain/SPEC.md` that apply to this task.
