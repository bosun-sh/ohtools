...
- `spec/07-effect-runtime/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Support AbortSignal cancellation and timeout options with documented error behavior.

## Scope

- Runtime cancellation, timeoutMs, and ignored promise result handling.
...
- Include all edge cases from `spec/07-effect-runtime/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/07-effect-runtime/SPEC.md` that apply to this task.
