...
- `spec/09-developer-experience/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Format errors with stable codes, affected paths, and suggested fixes where obvious.

## Scope

- Error message formatting and duplicate/schema/next-step/handler failures.
...
- Include all edge cases from `spec/09-developer-experience/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/09-developer-experience/SPEC.md` that apply to this task.
