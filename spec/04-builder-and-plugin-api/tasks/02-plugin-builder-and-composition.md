# Plugin Builder and Composition
...
- `spec/04-builder-and-plugin-api/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Implement plugin creation and deterministic .use(...) composition.

## Scope

- Plugin API, composition order, plugin diagnostics, and nested plugins.
...
- Include all edge cases from `spec/04-builder-and-plugin-api/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/04-builder-and-plugin-api/SPEC.md` that apply to this task.
