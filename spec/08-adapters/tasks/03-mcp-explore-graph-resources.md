# MCP Explore, Graph, and Resources
...
- `spec/08-adapters/SPEC.md`
- `docs/TASK-HARNESS.md`

## Goal

Expose exploration, graph serialization, and graph docs through MCP tools/resources.

## Scope

- ohtools.explore, ohtools.graph, and ohtools:// resources.
...
- Include all edge cases from `spec/08-adapters/SPEC.md` that apply to this task.
...
- Add or update the tests listed in `spec/08-adapters/SPEC.md` that apply to this task.
