...
Implement run planning that rejects invalid targets and returns handler output with next steps.

## Scope

- Run responses, run eligibility, and handler invocation boundary.
