# Graph Serialization and Cycles
...
Serialize graphs deterministically and traverse cycles without recursion overflow.

## Scope

- Graph serialization, sorted output, and cycle metadata.
