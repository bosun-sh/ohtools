...
Resolve static and functional next steps in declaration order with warning handling.

## Scope

- Next-step validation, resolver execution, optional targets, and warnings.
